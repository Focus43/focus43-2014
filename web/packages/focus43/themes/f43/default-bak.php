...
<body ng-app="focus-43" ng-class="{'loaded':loaded}">

    <div id="pre-init" class="tabular">
        <div class="cellular">
                ...
                <div class="tabular">
                    <div class="cellular">
                        <div class="container-auto max-645">
                            <div class="row">
                                <div class="col-sm-12">
                                    <img class="img-responsive" src="<?php echo FOCUS43_IMAGE_PATH; ?>3d-logo-lighter.png" alt="" />
                                </div>
                            </div>
                            <!--<div class="row">
                                <div class="col-sm-12">
            ...
            <div class="tabular">
                <div class="cellular">
                    <ul id="nav-list" class="list-unstyled">
                        <li><a nav-slide-to="0">Home</a></li>
                        <li><a nav-slide-to="1">About</a></li>
                        <li><a nav-slide-to="2">Drop A Line</a></li>
                    </ul>
                </div>
            </div>
        </div>
