<div class="page-content" tpl-contact>
    ...
    <div class="tabular">
        <div class="cellular">
            <form id="frmContact" class="container-fluid" name="contactForm" role="form" ng-submit="submit()" novalidate>
                <div class="row">
                    <div class="col-sm-12">
    ...
    <div class="map-instance" googlemap="mapOptions" map-instance="_gmap"></div>
</div>